...
#	print(panda.sysbus_create_varargs("l2x0", 503357440))
	...
	print(f"arm_cpu: {str(arm_cpu)}")
	print(f"cpu_name: {str(cpu_name)}")
	print(f"obj: {str(obj)}")
	print(f"obj_bool: {str(obj_bool)}")
	print(f"obj_property: {str(obj_property)}")
	print(f"obj_int: {str(obj_int)}")
	print(f"obj_2: {str(obj_2)}")
	print(f"obj_link: {str(obj_link)}")
	print(f"mem_reg: {str(mem_reg)}")
